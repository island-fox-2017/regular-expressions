...
//   let matchy = string.match(/\d{3}-\d{2}-\d{4}/); // with g : (/\d{3}-\d{2}-\d{4}/g) ("please don't share this: 234-60-1422 235-68-1472")
//   if (matchy !== null) {
//     return matchy[0];
//     // ?? why do matchy need an index [0]??
//   } else {
//     return null;
//   }
// }
...
// console.log(grab_ktp("please don't share this: 234-60-1422")) // true
//
...
// const grab_all_nomor_ktp = (stringg) => {
//   var result = [];
//   var string = stringg.split(',');
//   for (let i=0; i<string.length; i++) {
//     let matchyy = string[i].match(/\d{3}-\d{2}-\d{4}/);
//     if (matchyy !== null) {
//        result.push(matchyy[0]);
//     }
//   }
//   return result;
// }
...
// const hide_all_nomor_ktp = (stringg) => {
//   var result = [];
//   var temp = '';
//   var string = stringg.split(',');
//   for (let i=0; i<string.length; i++) {
...
//       if (matchyy !== null) {
//       temp = matchyy[0];
//         result.push('XXX-XX-'+temp.substr(7,4))
//         } else {
//         return stringg;
//         }
//     }
...
//   let matchString = string.replace(/(\d{3})-(\d{2})-(\d{4})/g, '$1-$2-$3');
//   matchString = matchString.replace(/\./g, '-');
//   matchString = matchString.replace(/(\d{3})(\d{2})(\d{4})/, '$1-$2-$3');
//   if(matchString !== null)
//   {
//     return matchString;
//   }
...
// console.log(format_nomor('234601422, 350.80.0744, 013-60-8762') === '234-60-1422, 350-80-0744, 013-60-8762') // true  // ?? gmn bkin trueee ???? join ny gmn yachh
//
