...
const has_ktp = (string) => {
  // ...
  let nomorKTP = /(\d{3})-(\d{2})-(\d{4})/;
  return nomorKTP.test(string);
}
...
const grab_ktp = (string) => {
  // ...
  let nomorKTP = /(\d{3})-(\d{2})-(\d{4})/;
  let match = string.match(nomorKTP);
...
const hide_all_nomor_ktp = (string) => {
  // ...
  let nomorKTP = /(\d{3})-(\d{2})-(\d{4})/g;
  return string.replace(nomorKTP, 'XXX-XX-$3');
}
...
const format_nomor = (string) => {
  // ...
  let nomorKTP = /(\d{3})\.*(\d{2})\.*(\d{4})/g;
  return string.replace(nomorKTP, '$1-$2-$3')
}
